...
function convertation(number, mass) {
    ...
    if (number == 0) {
        mass[0].num = 0;
        mass[0].count = 0;
        mass[0].order = '0'.repeat(8);
        mass[0].mantissa='0'.repeat(23);
    }
...
function def_of_sum(inputData, mass1, mass2, mass3) {
    ...
    if (mass1[0].count != mass2[0].count && mass1[0].count!=0 &&mass2[0].count!=0) {
...
if (arg[2] == 'calc') {
    ...
    if (b == 1) {      
        if (mass1[0].num <0 && Math.abs(mass1[0].num) > Math.abs(mass2[0].num)&&mass2[0].num!=0) {
        ...
        if (mass1[0].num>0 && (mass1[0].num >= mass2[0].num || mass2[0].num >= mass1[0].num)&&mass2[0].num!=0) {
            sum(mass1, mass2, mass3);
        }
        
        if (mass1[0].num == 0) {
            mass3 = mass2;
            mass3[0].mantissa = mass3[0].mantissa.slice(1,24);
            output = '0 '+mass3[0].order+' '+mass3[0].mantissa;
        }
    ...
    if (b == 0) {
        ...
        if (mass1[0].num > 0 && Math.abs(mass1[0].num) == Math.abs(mass2[0].num)) {
            mass3[0].order = '0'.repeat(9);
            mass3[0].mantissa = + '0'.repeat(23);
            output = "0" + " " +  mass3[0].order + " " + mass3[0].mantissa;
        }
        ...
        if (mass1[0].num == 0) {
            mass3 = mass2;
            mass3[0].mantissa = mass3[0].mantissa.slice(1,24);
            output = '1 '+mass3[0].order+' '+mass3[0].mantissa;
        }
